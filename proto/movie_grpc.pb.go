...
type MovieApiClient interface {
	...
	AddMovieToFav(ctx context.Context, in *RequestMAddMovieToFav, opts ...grpc.CallOption) (*ResponseAddMovieToFav, error)
...
func (c *movieApiClient) AddMovieToFav(ctx context.Context, in *RequestMAddMovieToFav, opts ...grpc.CallOption) (*ResponseAddMovieToFav, error) {
...
type MovieApiServer interface {
	...
	AddMovieToFav(context.Context, *RequestMAddMovieToFav) (*ResponseAddMovieToFav, error)
...
func (UnimplementedMovieApiServer) AddMovieToFav(context.Context, *RequestMAddMovieToFav) (*ResponseAddMovieToFav, error) {
...
func _MovieApi_AddMovieToFav_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieApiServer).AddMovieToFav(ctx, req.(*RequestMAddMovieToFav))
	}
	return interceptor(ctx, in, info, handler)
}
